...
<div class="menu_bg">
    <div class="menu">
        ...
        <!--End 商品分类详情 End-->
        <ul class="menu_r" id="horizontalMenu">
            ...
            <li v-for="temp in horizontalMenuList"><a v-bind:href="temp.url" v-text="temp.title"></a></li>
        </ul>
        ...
        <script type="text/javascript">
            const vue1 = new Vue({
                ...
                mounted() {
                    this.$http.post("<%=basePath %>/frontWebMenu/getHorizontalWebMenu.do").then(
                        function (rs) {
                            this.horizontalMenuList = rs.body;
                        });
                }
            });
        </script>
